...
public class CulturalOfferCategoryMapper implements MapperInterface<CulturalOfferCategory, CulturalOfferCategoryDTO>{
	...
	public CulturalOfferCategory toEntityNoTypes(CulturalOfferCategoryDTO dto) {
		return new CulturalOfferCategory(dto.getName());
	}
	...
	public CulturalOfferCategoryDTO toDtoNoTypes(CulturalOfferCategory entity) {
		CulturalOfferTypeMapper m = new CulturalOfferTypeMapper();
		return new CulturalOfferCategoryDTO(entity.getId(), entity.getName(), new ArrayList<>());
	}
